...
public class AmmoUIController : MonoBehaviour
{
    ...
    {
        PlayerBattleUIEventBus.Subscribe(PlayerBattleUIEventType.PlayerAmmoSet, SetAmmoRemaining);
    }

    private void OnDisable()
    {
        PlayerBattleUIEventBus.Unsubscribe(PlayerBattleUIEventType.PlayerAmmoSet, SetAmmoRemaining);
    }
