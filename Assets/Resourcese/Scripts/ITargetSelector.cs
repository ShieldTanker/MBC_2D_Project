...
{
    List<ITargetable> GetCandidates(Vector3 origin, float range, LockOnTuning tuning, Camera viewCamera, Transform self, Faction selfFaction, ITargetable currentTarget);
}
